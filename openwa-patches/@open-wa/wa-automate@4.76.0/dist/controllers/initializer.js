...
function create(config = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield waPage.waitForFunction('window.Debug!=undefined && window.Debug.VERSION!=undefined && require', { timeout: 5000 }).catch(() => {});
            //@ts-ignore
            const WA_VERSION = yield waPage.evaluate(() => (window.Debug && window.Debug.VERSION) || "2.3000.1012345678");
